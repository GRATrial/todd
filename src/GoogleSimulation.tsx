    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#fff' }}>
      ...
      <div style={{ maxWidth: '1128px', margin: '0 auto', padding: '0 16px' }}>
        ...
        <div style={{ paddingTop: '20px', paddingBottom: '8px' }}>
          <button
            onClick={() => {
              trackEvent({ eventType: 'click', elementType: 'done_searching_button', elementText: 'Done Searching', persona: 'todd', page: currentPage, tab: activeTab });
              if (!returnUrl) {
        ...
        <div style={{ display: 'flex', gap: '32px' }}>
          ...
          <div style={{ flex: '1', minWidth: 0 }}>
            ...
            <div style={{ color: '#70757a', fontSize: '14px', marginBottom: '16px' }}>
              About 4,120,000 results (0.31 seconds)
            </div>
