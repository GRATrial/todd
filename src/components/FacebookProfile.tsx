...
export const FacebookProfileView: React.FC<FacebookProfileProps> = ({ resultId, onClose }) => {
  ...
  return (
    ...
    >
      ...
      {/* Top Navbar */}
      <div style={{ backgroundColor: 'white', borderBottom: '1px solid #ddd', position: 'sticky', top: 41, zIndex: 100, height: '56px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px' }}>
        ...
        {activeTab === 'All' ? (
          <div style={{ display: 'flex', gap: '16px' }}>
            ...
            <div style={{ width: '400px', flexShrink: 0 }}>
              <div style={{ backgroundColor: 'white', borderRadius: '8px', padding: '16px', boxShadow: '0 1px 2px rgba(0,0,0,0.1)', marginBottom: '16px' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                  <h2 style={{ fontSize: '20px', fontWeight: 700 }}>Photos</h2>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                {activeTab === 'Photos' && (
                  <div style={{ textAlign: 'left' }}>
                    <div style={{ display: 'flex', gap: '24px', borderBottom: '1px solid #ddd', marginBottom: '16px' }}>
                      <div style={{ padding: '8px 0', borderBottom: '3px solid #1877f2', color: '#1877f2', fontWeight: 600, cursor: 'pointer' }}>{profile.name}'s Photos</div>
            ...
            {/* Photos section for About and Friends tabs */}
            {(activeTab === 'About' || activeTab === 'Friends') && (
              <div style={{ backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 1px 2px rgba(0,0,0,0.1)', overflow: 'hidden' }}>
                <div style={{ padding: '20px 16px' }}>
                  <h2 style={{ fontSize: '20px', fontWeight: 700, margin: 0 }}>Photos</h2>
                </div>
